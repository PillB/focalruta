...
[['#perspective-position','input',updatePerspective],['#perspective-focal','change',updatePerspective],['#vertical-tilt','input',updateVertical],['#hierarchy-mode','change',updateHierarchy],['#light-mode','change',updateLight]].forEach(([selector,event,handler])=>document.querySelector(selector).addEventListener(event,handler));updatePerspective();updateVertical();updateHierarchy();updateLight();
