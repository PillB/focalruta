  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="optics-layout">
      ...
      <div class="optics-control-card">
        ...
        <div id="opt-status" class="optics-status" role="status" aria-live="polite"></div><div id="opt-exposure" class="optics-exposure" role="status">Exposición: —</div>
...
JS = r'''function initOpticsLab(){
 ...
 function update(){
  ...
  document.getElementById('opt-dist-v').textContent=d.toFixed(1)+' m';document.getElementById('opt-bg-v').textContent=b.toFixed(1)+' m';document.getElementById('opt-light-v').textContent='EV '+sceneEV;document.getElementById('opt-fov').textContent=fov.toFixed(1)+'°';document.getElementById('opt-width').textContent=width.toFixed(2)+' m';document.getElementById('opt-dof').textContent=fmt(near)+' → '+fmt(far);document.getElementById('opt-total').textContent=fmt(total);document.getElementById('opt-split').textContent=fmt(front)+' / '+fmt(behind);document.getElementById('opt-hyper').textContent=fmt(H/1000);document.getElementById('opt-blur').textContent=blur.toFixed(3)+' mm · '+blurCoc.toFixed(1)+'× CoC';
